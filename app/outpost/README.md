...
![frontend-not-started](./docs/img/panel-not-started.png)

After clicking the "Start" button, the game instance status is updated to "droplet-creating."

![frontend-not-started](./docs/img/panel-droplet-creating.png)
...
![frontend-not-started](./docs/img/panel-running.png)
...
Special thanks to Christian Dodge for his valuable feedback on this project.
